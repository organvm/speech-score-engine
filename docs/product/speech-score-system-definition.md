...
That sentence is the naming test. If a new label obscures either side of that duality, reject it. This follows directly from the system invariant that language must remain both meaning-bearing and temporally operative. fileciteturn3file6
